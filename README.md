...
Web app nội bộ cho bộ phận Product Development của công ty may FOB: nhân viên vào app chỉ cần
nhập mã nhân viên (không mật khẩu, không tài khoản), theo dõi tiến độ mã hàng qua các bước
công việc (Proto1/2/3, SMS, Sizeset, PPS...) theo deadline; quản lý (Admin/Brand Leader) cấu
hình khách hàng/mùa/bước công việc, phân công, xem báo cáo tổng hợp.
...
> "giả danh" bất kỳ nhân viên nào chỉ bằng cách gõ đúng mã NV của họ (không cần mật khẩu) —
> phân quyền admin/brand_leader/employee chỉ còn là gợi ý giao diện, **không** được database
> enforce. Chỉ phù hợp nếu dữ liệu không nhạy cảm hoặc bạn chấp nhận rủi ro này khi host public.
...
src/
  ...
  routes/     Login (nhập mã nhân viên), Home, CustomerStyles, StyleProgress,
